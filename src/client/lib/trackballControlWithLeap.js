...
console.log("Extended fingers: " + extendedFingers);
          ...
          // trying to do zoom, but not done yet
          // if (extendedFingers == 2){
					_movePrev.copy( _moveCurr );
					// _moveCurr.copy( getMouseOnCircle( hand.palmPosition[0]*10, 200 ) );
					_moveCurr.copy( getMouseOnCircle( hand.palmPosition[0]*12, hand.palmPosition[2]*1.5 ) );					
